...
**Open, unblocked, lower priority than the redirect above:** PIC-36 (`pb_draft_cup` fp anatomy), PIC-38 (chance-adjusted lift recompute — largely already answered negatively by PIC-39's red-team finding), PIC-40 (`court_wedge`/`cut.py` CLI wiring), PIC-43's remaining `court_wedge` piece. PIC-31 needs a steer on which PIC-42 candidate to pursue.
